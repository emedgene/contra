# ----------------------------------------------------------------------#
# Copyright (c) 2011, Richard Lupat, Jason Li, Adam Lev-Libfeld
#
# > Source License <
    ...
    for target in targetList:
        ...
        if (prevchr != chr):
            ...
            if not os.path.isfile(ff):
                sys.stderr.write("WARNING: %s NOT FOUND (should be generated by splitByChromosome3). Likely due to no reads found in a targeted chromosome (%s), in turn likely due to currupted bam files\n" %
                    (ff,chr))
                #sys.exit(1)
                covFile=[]
            else:
